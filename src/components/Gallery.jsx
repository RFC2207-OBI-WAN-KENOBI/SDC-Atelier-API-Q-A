...
class Gallery extends React.Component {
  ...
  render () {
    return (
      <div>
        {this.props.style.photos.map((photo, index) => (
        <Photo key={index} photo={photo} last={this.props.style.photos.length - 1} index={this.props.style.photos.indexOf(photo)} display={this.display.bind(this)} next={this.props.movePhoto} prev={this.props.movePhoto} triggerModal={this.triggerModal.bind(this)} photos={this.props.style.photos}/>))}
